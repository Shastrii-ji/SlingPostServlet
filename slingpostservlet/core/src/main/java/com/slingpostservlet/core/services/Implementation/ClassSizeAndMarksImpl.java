package com.slingpostservlet.core.services.Implementation;

import com.slingpostservlet.core.services.ClassSizeAndMarks;
import com.slingpostservlet.core.services.Configuration.ClassConfigurationService;
import com.slingpostservlet.core.services.Student;
import com.slingpostservlet.core.services.ClassSizeAndMarks;
import com.slingpostservlet.core.services.Configuration.ClassConfigurationService;
import com.slingpostservlet.core.services.Student;
...
public class ClassSizeAndMarksImpl implements ClassSizeAndMarks {
    ...
    public boolean isClassSizeLimited(List<Student> listOfStudents) {
        ...
        if(StudentConfigImpl.listOfStudents.size() < allowedSize)
            return true;
        return false;
    }
